...
namespace TourDuLichASAP.API.Migrations
{
    ...
    [Migration("20240320145926_AllowNullSomeTable")]
    partial class AllowNullSomeTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TourDuLichASAP.API.Models.Domain.DatTour", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SoLuongNguoiLon = 2,
                            SoLuongTreEm = 1,
                            ThoiGianDatTour = new DateTime(2024, 3, 20, 21, 59, 25, 726, DateTimeKind.Local).AddTicks(1692),
            ...
            modelBuilder.Entity("TourDuLichASAP.API.Models.Domain.KhachHang", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GioiTinh = "Nữ",
                            MatKhau = "password123",
                            NgayDangKy = new DateTime(2024, 3, 20, 21, 59, 25, 726, DateTimeKind.Local).AddTicks(1545),
                        ...
                        new
                        {
                            ...
                            GioiTinh = "Nam",
                            MatKhau = "abc123",
                            NgayDangKy = new DateTime(2024, 3, 20, 21, 59, 25, 726, DateTimeKind.Local).AddTicks(1548),
            ...
            modelBuilder.Entity("TourDuLichASAP.API.Models.Domain.NhanVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GioiTinh = "Nữ",
                            MatKhau = "password123",
                            NgayDangKy = new DateTime(2024, 3, 20, 21, 59, 25, 726, DateTimeKind.Local).AddTicks(1502),
                            NgaySinh = new DateTime(1995, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayVaoLam = new DateTime(2024, 3, 20, 21, 59, 25, 726, DateTimeKind.Local).AddTicks(1514),
                            SoDienThoai = "0987654321",
                        ...
                        new
                        {
                            ...
                            GioiTinh = "Nam",
                            MatKhau = "abc123",
                            NgayDangKy = new DateTime(2024, 3, 20, 21, 59, 25, 726, DateTimeKind.Local).AddTicks(1519),
                            NgaySinh = new DateTime(1988, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayVaoLam = new DateTime(2024, 3, 20, 21, 59, 25, 726, DateTimeKind.Local).AddTicks(1520),
                            SoDienThoai = "0365478912",
            ...
            modelBuilder.Entity("TourDuLichASAP.API.Models.Domain.TourDuLich", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayThem = new DateTime(2024, 3, 20, 21, 59, 25, 726, DateTimeKind.Local).AddTicks(1667),
                        ...
                        new
                        {
                            ...
                            NgayThem = new DateTime(2024, 3, 20, 21, 59, 25, 726, DateTimeKind.Local).AddTicks(1672),
                            NoiKhoiHanh = "Buôn Ma Thuột",
