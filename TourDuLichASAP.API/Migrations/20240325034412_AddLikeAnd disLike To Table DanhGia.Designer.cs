...
namespace TourDuLichASAP.API.Migrations
{
    ...
    [Migration("20240325034412_AddLikeAnd disLike To Table DanhGia")]
    partial class AddLikeAnddisLikeToTableDanhGia
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TourDuLichASAP.API.Models.Domain.DatTour", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SoLuongNguoiLon = 2,
                            SoLuongTreEm = 1,
                            ThoiGianDatTour = new DateTime(2024, 3, 25, 10, 44, 10, 698, DateTimeKind.Local).AddTicks(4281),
            ...
            modelBuilder.Entity("TourDuLichASAP.API.Models.Domain.KhachHang", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GioiTinh = "Nữ",
                            MatKhau = "password123",
                            NgayDangKy = new DateTime(2024, 3, 25, 10, 44, 10, 698, DateTimeKind.Local).AddTicks(4234),
                        ...
                        new
                        {
                            ...
                            GioiTinh = "Nam",
                            MatKhau = "abc123",
                            NgayDangKy = new DateTime(2024, 3, 25, 10, 44, 10, 698, DateTimeKind.Local).AddTicks(4237),
            ...
            modelBuilder.Entity("TourDuLichASAP.API.Models.Domain.NhanVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GioiTinh = "Nữ",
                            MatKhau = "password123",
                            NgayDangKy = new DateTime(2024, 3, 25, 10, 44, 10, 698, DateTimeKind.Local).AddTicks(4200),
                            NgaySinh = new DateTime(1995, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayVaoLam = new DateTime(2024, 3, 25, 10, 44, 10, 698, DateTimeKind.Local).AddTicks(4211),
                            SoDienThoai = "0987654321",
                        ...
                        new
                        {
                            ...
                            GioiTinh = "Nam",
                            MatKhau = "abc123",
                            NgayDangKy = new DateTime(2024, 3, 25, 10, 44, 10, 698, DateTimeKind.Local).AddTicks(4215),
                            NgaySinh = new DateTime(1988, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayVaoLam = new DateTime(2024, 3, 25, 10, 44, 10, 698, DateTimeKind.Local).AddTicks(4216),
                            SoDienThoai = "0365478912",
            ...
            modelBuilder.Entity("TourDuLichASAP.API.Models.Domain.TourDuLich", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayThem = new DateTime(2024, 3, 25, 10, 44, 10, 698, DateTimeKind.Local).AddTicks(4260),
                        ...
                        new
                        {
                            ...
                            NgayThem = new DateTime(2024, 3, 25, 10, 44, 10, 698, DateTimeKind.Local).AddTicks(4264),
                            NoiKhoiHanh = "Buôn Ma Thuột",
